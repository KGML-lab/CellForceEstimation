...
fold = args.fold
source = "./CellForces/CrossValidation/" + fold +"/"  #./data_fluoro_nodes_fake/"
dest_train = source + "train/"  #"./data_fluoro_nodes_fake/train/"
dest_test = source + "test/" #"./data_fluoro_nodes_fake/test/"
...
def get_board_dicts(imgdir, mode):
    ...
    for i in dataset_dicts:
        ...
        if mode is 'test':
            i["file_name"] = imgdir+ "/" + mode + "/images_resized/"+filename 
...
cfg.DATASETS.TEST = ("boardetect_train",)
cfg.OUTPUT_DIR = ("../output_fluro_retinanet_complete_annotations_"+ fold)
